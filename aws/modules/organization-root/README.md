...
| Name | Type |
|------|------|
| [aws_cloudtrail.main](https://registry.terraform.io/providers/hashicorp/aws/4.44.0/docs/resources/cloudtrail) | resource |
| [aws_organizations_organization.main](https://registry.terraform.io/providers/hashicorp/aws/4.44.0/docs/resources/organizations_organization) | resource |
...
| <a name="input_logs-bucket"></a> [logs-bucket](#input\_logs-bucket) | The name of the bucket to write the trail to | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_outputs"></a> [outputs](#output\_outputs) | A mapping containing organization outputs like the ID and ARN. |
